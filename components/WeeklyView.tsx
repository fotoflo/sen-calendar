...
const DayBox: React.FC<{ day: Date, events: CalendarEvent[] }> = ({ day, events }) => {
  ...
  return (
    <div className="p-3 flex flex-col h-full min-h-0">
      ...
      <div className="mt-1 space-y-2 overflow-y-auto flex-1 min-h-0 border-t border-gray-200 pt-2">
         {dayEvents.map(event => (
...
export const WeeklyView: React.FC<WeeklyViewProps> = ({ date, events, layout, logo }) => {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 h-full">
      ...
      <div className="flex flex-col flex-1 min-h-0 border border-gray-400">
        <div className={`grid ${topRowCols} border-b border-gray-400 flex-1 min-h-0`}>
        ...
        <div className={`grid ${bottomRowCols} flex-1 min-h-0`}>
